...
The error correctly points to the position after the `=` operator on line 2, where an expression was expected but none was found.
...
Error in 'example3.pars':
  line 1, column 17: unexpected 'let'
    let result = 5 +
                    ^
```
